...
//       let cellNo: number;
//       let parsedValue: string | null;
//       let responseType: "individualCells" | "csu11" | "csu12" = "individualCells";
...
//             `SerialTerminal: Parsed cellNo: ${cellNo}, id: ${extractedId}, value: ${parsedValue} for ${command}`
//           );
//         } else if (command.includes("12_csu")) {
//           const {
//             cellNo: extractedCellNo,
//             id: extractedId,
//             value,
...
//             id: extractedId,
//             value,
//           } = extract11CSUTemperature(hexArray); // Fallback for non-CSU int types
//           cellNo = extractedCellNo;
//           parsedValue = value;
//           console.log(
//             `SerialTerminal: Parsed cellNo: ${cellNo}, id: ${extractedId}, value: ${parsedValue} for ${command}`
...
//   // Update responseData based on responseType
//   setResponseData((prevData) => {
//     const dataKey = responseType;
//     const existingDataForCell = prevData[dataKey][cellNo] || [];
//     const newResponseEntry: ResponseData = {
//       command,
//       value: parsedValue,
//     };
//     console.log(
//       `SerialTerminal: Mapping ${dataKey} Cell ID ${cellNo} with ${command}: ${parsedValue}`
//     );
//     return {
//       ...prevData,
//       [dataKey]: {
...
//   title: string,
//   data: Record<number, ResponseData[]> | undefined
// ) => {
//   if (!data || Object.keys(data).length === 0) {
//     console.log(`SerialTerminal: No data to render for ${title}`);
//     return null;
//   }
//   return (
//     <div className="space-y-2">
...
//           .sort(([a], [b]) => Number(a) - Number(b))
//           .map(([cellId, dataItems]) => {
//             console.log(`SerialTerminal: Rendering ${title} Cell ID: ${cellId}`);
//             return (
//               <div key={cellId} className="text-gray-800 break-all mb-2">
//                 <div className="font-semibold text-blue-600">
//                   Cell {cellId}
...
//       {renderCellData("Individual Cells", responseData.individualCells)}
//       {renderCellData("CSU 11", responseData.csu11)}
//       {renderCellData("CSU 12", responseData.csu12)}
