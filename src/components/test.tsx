...
//     parsedValue = (value / 10000).toFixed(3); // Corrected scaling
...
//             const scaledValue = Math.round(value * 10000); // Scale to match expected format
//             if (isNaN(value) || scaledValue < 0 || scaledValue > 65535) {
//               setError(
//                 `Invalid voltage for ${command}: ${entry.voltage ?? "undefined"}`
//               );
//               continue;
//             }
...
//             if (value !== 0 && value !== 1) {
//               setError(
//                 `Invalid binary value for ${command}: ${entry.value ?? "undefined"}`
//               );
//               continue;
//             }
//             frame[4] = value & 0xff;
...
//             if (isNaN(value)) {
//               setError(
//                 `Invalid delay value for ${command}: ${entry.value ?? "undefined"}`
//               );
//               continue;
//             }
//             frame[4] = value & 0xff;
...
//                   {cell.voltage != null && (
//                     <div className="flex justify-between">
//                       <span>Received Voltage (Individual):</span>
//                       <span
//                         className={`font-medium ${
...
//                   {cell.csu11Voltage != null && (
//                     <div className="flex justify-between">
//                       <span>Received Voltage (CSU11):</span>
//                       <span
//                         className={`font-medium ${
//                           cell.csu11Voltage > 4.5 || cell.csu11Voltage < 2.0
//                             ? "text-red-600"
//                             : ""
//                         }`}
//                       >
//                         {cell.csu11Voltage.toFixed(3)} V
//                       </span>
//                     </div>
//                   )}
//                   {cell.csu12Voltage != null && (
//                     <div className="flex justify-between">
//                       <span>Received Voltage (CSU12):</span>
//                       <span
//                         className={`font-medium ${
//                           cell.csu12Voltage > 4.5 || cell.csu12Voltage < 2.0
//                             ? "text-red-600"
//                             : ""
//                         }`}
//                       >
//                         {cell.csu12Voltage.toFixed(3)} V
//                       </span>
//                     </div>
//                   )}
//                   {cell.setTemperature != null && (
...
//                   {cell.temperature != null && (
//                     <div className="flex justify-between">
//                       <span>Received Temperature (Individual):</span>
//                       <span>{cell.temperature.toFixed(3)} °C</span>
//                     </div>
//                   )}
//                   {cell.csu11Temperature != null && (
//                     <div className="flex justify-between">
//                       <span>Received Temperature (CSU11):</span>
//                       <span>{cell.csu11Temperature.toFixed(3)} °C</span>
//                     </div>
//                   )}
//                   {cell.csu12Temperature != null && (
//                     <div className="flex justify-between">
//                       <span>Received Temperature (CSU12):</span>
//                       <span>{cell.csu12Temperature.toFixed(3)} °C</span>
//                     </div>
//                   )}
//                   {cell.balancing && (
//                     <div className="flex justify-between">
//                       <span>Balancing (Individual):</span>
//                       <span className="text-green-600">On</span>
//                     </div>
//                   )}
//                   {cell.csu11Balance && (
//                     <div className="flex justify-between">
//                       <span>Balancing (CSU11):</span>
//                       <span className="text-green-600">On</span>
//                     </div>
//                   )}
//                   {cell.csu12Balance && (
//                     <div className="flex justify-between">
//                       <span>Balancing (CSU12):</span>
//                       <span className="text-green-600">On</span>
//                     </div>
//                   )}
//                   {cell.openWire && (
//                     <div className="flex justify-between">
//                       <span>Open Wire (Individual):</span>
//                       <span className="text-red-600">On</span>
//                     </div>
//                   )}
//                   {cell.csu11OpenWire && (
//                     <div className="flex justify-between">
//                       <span>Open Wire (CSU11):</span>
//                       <span className="text-red-600">On</span>
//                     </div>
//                   )}
//                   {cell.csu12OpenWire && (
//                     <div className="flex justify-between">
//                       <span>Open Wire (CSU12):</span>
//                       <span className="text-red-600">On</span>
//                     </div>
//                   )}
//                   {cell.daisyChain != null && (
...
//                       <span
//                         className={
//                           cell.daisyChain === "On" ? "text-green-600" : ""
//                         }
//                       >
//                         {cell.daisyChain}
//                       </span>
...
// //show all data in cell data section
// import React, { useEffect, useState, useRef } from "react";
// import { useBatteryContext } from "../BatteryContext";
// import { useSerial } from "../SerialContext";
...
//                   {cell.dcCsuVoltage != null && (
//                     <div className="flex justify-between">
//                       <span>Received Voltage (DC CSU):</span>
//                       <span
//                         className={`font-medium ${
//                           cell.dcCsuVoltage > 4.5 || cell.dcCsuVoltage < 2.0
//                             ? "text-red-600"
//                             : ""
//                         }`}
//                       >
//                         {cell.dcCsuVoltage.toFixed(3)} V
//                       </span>
//                     </div>
//                   )}
//                   {cell.csu11Voltage != null && (
...
//                   {cell.dcCsuTemperature != null && (
//                     <div className="flex justify-between">
//                       <span>Received Temperature (DC CSU):</span>
//                       <span>{cell.dcCsuTemperature.toFixed(3)} °C</span>
//                     </div>
//                   )}
//                   {cell.csu11Temperature != null && (
//                     <div className="flex justify-between">
