...
//   // Compute local statuses for individual cells
//   useEffect(() => {
...
//         setVoltage !== null ? `Set Voltage: ${setVoltage} V` : null,
...
//   // Filter statuses for errors, warnings, normals, and N/A
//   const errors = [
...
//   const naStatuses = [
//     ...mergedCsu1Statuses.filter(item => item.status === 'N/A'),
//     ...mergedCsu2Statuses.filter(item => item.status === 'N/A'),
//     ...mergedDaisyStatuses.filter(item => item.status === 'N/A'),
//   ];
...
//             ⚪ N/A <span className="text-xs bg-gray-100 text-gray-700 px-2 py-0.5 rounded-full">{naStatuses.length}</span>
//           </h3>
//           {renderList(naStatuses, 'text-gray-800', 'bg-gray-50 border-gray-200')}
//         </div>
//       )}

//       {errors.length === 0 && warnings.length === 0 && normals.length === 0 && naStatuses.length === 0 && (
//         <div className="text-gray-500 text-sm bg-gray-50 border border-gray-200 rounded-lg p-3 text-center">
//           No cell status data available.
//         </div>
//       )}
