...
const Daicy: React.FC = () => {
  const { dcCsuResponseData, instructions, setDaisyStatuses, setCriticalState } = useBatteryContext();
  ...
  }, [dcCsuResponseData, instructions, setDaisyStatuses, setCriticalState]);
