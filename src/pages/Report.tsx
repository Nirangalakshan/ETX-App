...
//           const status = openWireItem && openWireItem.value === "On" ? "warning" : "normal";
...
//     // No Data
//     if (
//       csu1Cells.every((cell) => cell.status === "normal") &&
//       csu2Cells.every((cell) => cell.status === "normal") &&
...
//           <h1 className="text-3xl font-bold text-gray-800">Battery System Report</h1>
//           <button
...
//           {/* CSU1 Summary */}
//           <div>
//             <h2 className="text-2xl font-semibold text-gray-700 mb-4">CSU1 Summary</h2>
...
//           {/* CSU2 Summary */}
//           <div>
//             <h2 className="text-2xl font-semibold text-gray-700 mb-4">CSU2 Summary</h2>
//             <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
//               <div>
//                 <p className="text-sm text-gray-600">Total Cells</p>
//                 <p className="text-lg font-medium">12</p>
...
//           {/* Daisy Chain Summary */}
//           <div>
//             <h2 className="text-2xl font-semibold text-gray-700 mb-4">Daisy Chain Summary</h2>
//             <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
//               <div>
//                 <p className="text-sm text-gray-600">Total Cells</p>
