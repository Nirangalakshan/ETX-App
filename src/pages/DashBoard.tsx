...
//           break;
//         case "set_temp":
//           updatedCell.temperature =
//             parseFloat(instruction.temperature) || updatedCell.temperature;
//           break;
//       }
...
//           if (updatedCell.voltage < 2.5) {
//             newStatus = "critical";
//           } else if (updatedCell.voltage < 3.0) {
//             newStatus = "warning";
//           }
//         }
...
//       }
//     });
//   }, [responseData, csu1Cells, csu2Cells, updateCellVoltage]);
...
//           <div className="ml-20">
//             <SerialTerminal responseData={responseData} setResponseData={setResponseData} updateCellVoltage={updateCellVoltage} 
